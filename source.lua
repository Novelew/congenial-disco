...
local prompt = useStudio and require(script.Parent.prompt) or loadWithTimeout('https://raw.githubusercontent.com/Novelew/congenial-disco/refs/heads/main/prompt.lua')
...
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://raw.githubusercontent.com/Novelew/congenial-disco/refs/heads/main/icons.lua')
-- Variables
...
--	task.spawn(loadWithTimeout, "https://raw.githubusercontent.com/Novelew/congenial-disco/refs/heads/main/boost.lua")
--end
